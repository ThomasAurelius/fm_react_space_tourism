...
export default function DestinationEuropa() {
   return (
      ...
      <div id="europa" className="container  destination-container grid">
        ...
        <div className="destination-text">
          ...
          <h2 className="destination-name uppercase fs-800">Europa</h2>
          <p>
